...
const marqueeItems = ['Brand Identity', 'Web Design', 'UX Research', 'Motion Design', 'Conversion Rate', 'Product Strategy', 'Design Systems', 'Dev Engineering', 'SEO & Growth'];
...
export default function HomePage() {
  return (
    <>
        ...
        <div className="app-container relative z-10 py-20 px-6 w-full">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            ...
            <div className="flex flex-col items-start">
              ...
              <p className="t-base c-muted anim-fade-up d2 max-w-[480px] mb-10">
              ...
              <div className="anim-fade-up d5 flex flex-wrap items-center gap-6 mt-16">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="t-xs c-muted mt-1">150+ happy clients</div>
                  </div>
                </div>
                ...
                {[['$40M+', 'Revenue'], ['250+', 'Shipped']].map(([v, l]) => (
                  <div key={v}>
                    ...
                    <div className="t-xs c-muted mt-px">{l}</div>
                  </div>
                ))}
              </div>
            </div>
              ...
              <div className="relative w-full max-w-[440px]">
                ...
                <div className="anim-float bg-surface rounded-2xl p-10 border border-border w-full shadow-[0_30px_60px_rgba(0,0,0,0.04)] relative z-[2]">
                  <div className="flex justify-between items-center mb-10">
                    <div>
                      <div className="t-xs c-muted flex items-center gap-1.5">
                  ...
                  <div className="flex flex-col gap-5">
                    {[['Brand Perception', '↑ 84%'], ['Lead Quality', '↑ 61%'], ['Conversion Rate', '↑ 43%']].map(([k, v]) => (
                      <div key={k} className="flex justify-between pb-4 border-b border-bg-alt">
                        <span className="t-sm c-muted font-medium">{k}</span>
      ...
      {/* ── Services ──────────────────────────────────────────── */}
      <section id="services" className="section bg-page">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {services.map(s => (
              <article key={s.num} id={`service-${s.num}`} className="card group p-8 min-h-[320px] flex flex-col">
                ...
                <p className="t-sm c-muted leading-[1.6] mb-auto">{s.desc}</p>
