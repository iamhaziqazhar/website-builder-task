    ...
    <>
      ...
      <section id="about-hero" className="pt-40 px-6 pb-24 bg-hero-grad relative overflow-hidden border-b border-border">
        <div className="app-container">
          ...
          <p className="t-base c-muted anim-fade-up d2 max-w-[540px]">
      ...
      {/* ── Story ────────────────────────────────────────────── */}
      <section id="our-story" className="section bg-page">
        ...
        <div className="app-container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div id="mission-card" className="card group">
              ...
              <p className="t-sm c-muted leading-[1.7]">
            ...
            <div id="vision-card" className="card group">
              <div className="text-accent w-14 h-14 rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-500"><Eye size={32} /></div>
              <div className="t-xs text-dark-muted mb-4">Our Vision</div>
              <h3 className="t-md text-fg mb-4">Consectetur adipiscing elit.</h3>
              <p className="t-sm text-dark-muted leading-[1.7]">
              ...
              {values.map(v => (
                <div key={v.title} className="card p-6 flex gap-5 items-start group">
                  ...
                  <div>
                    ...
                    <p className="t-sm c-muted">{v.desc}</p>
                  </div>
                </div>
              ))}
            </div>
      ...
      {/* ── Team ─────────────────────────────────────────────── */}
      <section id="team" className="section bg-page border-t border-border">
        <div className="app-container">
          <div className="text-center mb-16">
            <h2 className="t-xl text-fg max-w-[500px] mx-auto mb-4">Our Team</h2>
            <p className="t-base c-muted max-w-[400px] mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {team.map(m => (
              <article key={m.id} id={`team-${m.id}`} className="card group">
                ...
                <p className="t-sm c-muted leading-[1.7] mb-8">{m.bio}</p>
                <div className="pt-6 border-t border-border flex justify-between items-center">
                  <span className="t-xs c-muted">Expertise: <span className="text-fg">{m.specialty}</span></span>
      ...
      {/* ── CTA ──────────────────────────────────────────────── */}
      <section id="about-cta" className="section bg-page text-center">
